...
public class NextGui extends JFrame implements MouseListener, ActionListener
{
	...
	public NextGui(FGame fg)
	{
		super("This is Next GUI");
		this.fg = fg;
		...
		textLabel = new JLabel("Yes, you are a Fool.");
		textLabel.setBounds(190, 150, 500, 30);
